...
void MainWindow::paintEvent(QPaintEvent *e)
{
  ...
  QPainter painter(this);
    ...
    if(segg){
        if(p1.playerTurn)
            b.suggestion(painter,senderObj,p1.piecesName,p1.piecesPosition,p2.piecesPosition,p1.playerTurn,p1.pawnProm,p2.pawnEnPassant);
        else
            b.suggestion(painter,senderObj,p2.piecesName,p2.piecesPosition,p1.piecesPosition,p1.playerTurn,p2.pawnProm,p1.pawnEnPassant);
    }
    if(timerActive){
